...
module @test_lock_sym_name {
  ...
  %l33_1 = AIE.lock(%t33, 1) { access_name = "my_lock", zero_state = 1, one_state = 0 }
  // Releasing/acquiring my_lock@0 will release/acquire %l33_0@0 and %l33_1@1.
  // Releasing/acquiring my_lock@1 will release/acquire %l33_0@1 and %l33_1@0.
}
